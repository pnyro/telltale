...
| `telltale capture [--hours N] [--output PATH]` | Capture historical events to a JSON fixture file |
| `telltale replay --input PATH [--severity LEVEL]` | Replay captured events through the rule engine (dry run) |
